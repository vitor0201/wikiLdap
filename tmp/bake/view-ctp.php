...
<div class="row">
    <div class="col-md-2" id="actions-sidebar">
        <div class="box box-primary">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><CakePHPBakeOpenTag= $this->Form->postLink(__('Deletar {0}', ['<?= $singularHumanName ?>']), ['action' => 'delete', <?= $pk ?>], ['confirm' => __('Are you sure you want to delete # {0}?', <?= $pk ?>)]) CakePHPBakeCloseTag> </li>
        ...
        ?>
                ...
                <li><CakePHPBakeOpenTag= $this->Html->link(__('NovoNew {0}', ['<?= Inflector::humanize(Inflector::singularize(Inflector::underscore($alias))) ?>']), ['controller' => '<?= $details['controller'] ?>', 'action' => 'add']) CakePHPBakeCloseTag> </li>
        <?php
    ...
    <div class="<?= $pluralVar ?> col-lg-10 col-md-9">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><CakePHPBakeOpenTag= h($<?= $singularVar ?>-><?= $displayField ?>) CakePHPBakeCloseTag></h3>
            </div>
            <div class="box-body">
