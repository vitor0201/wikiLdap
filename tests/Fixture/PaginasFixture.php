...
class PaginasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subcategoria_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'paginas_subcategoria_id' => ['type' => 'foreign', 'columns' => ['subcategoria_id'], 'references' => ['subcategorias', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
