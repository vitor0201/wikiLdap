...
class SubcategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'categorias_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'subcategorias_categorias_id' => ['type' => 'foreign', 'columns' => ['categorias_id'], 'references' => ['categorias', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
